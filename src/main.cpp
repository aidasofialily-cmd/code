...
int main() {
    ...
    if (score > initialHighscore) {
        std::cout << CLR_NORM << "Congratulations! A new personal best (previously: " << formatWithCommas(initialHighscore) << ")!" << CLR_RESET << "\n";
    }
