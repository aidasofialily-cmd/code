...
int main() {
    ...
    double cps = manual_clicks / duration;
    ...
    std::cout << "--------------------------\n"
              << "     PERFORMANCE STATS    \n"
              << "--------------------------\n"
              << " Manual Clicks : " << CLR_CTRL << formatWithCommas(manual_clicks) << CLR_RESET << "\n"
              << " Time Played   : " << CLR_CTRL << std::fixed << std::setprecision(2) << duration << "s" << CLR_RESET << "\n"
              << " Average CPS   : " << CLR_CTRL << std::fixed << std::setprecision(2) << cps << " clicks/sec" << CLR_RESET << "\n"
              << "--------------------------\n\n"
              << "Thanks for playing!\n";
    std::cout << "\033[?25h" << std::flush;
    return 0;
