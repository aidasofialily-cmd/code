...
## 2024-10-24 - Explicit Empty States for Gamification
**Learning:** Users playing the CLI game missing an initial high score see an empty UI, missing an onboarding opportunity and hiding the goal.
