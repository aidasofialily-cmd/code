...
## 2024-05-27 - Encouraging Empty States in CLI
**Learning:** In CLI applications, hiding UI elements when data is empty (like a high score of 0) leaves users wondering if the system is tracking their progress. Providing an explicit, encouraging empty state clarifies the system state and improves user onboarding.
