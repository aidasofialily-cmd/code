...
## 2024-05-24 - Empty State for Scores
**Learning:** In CLI games, when users first start, showing no high score information can make the system state unclear. Explicitly stating that there is no high score yet (an empty state) provides immediate context and encouragement.
