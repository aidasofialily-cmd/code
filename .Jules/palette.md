...
## 2024-05-23 - Readability of Large Numbers in CLI
**Learning:** In terminal-based games where scores can grow rapidly, large unformatted numbers (e.g., 1000000) are difficult to read at a glance. Adding thousands-separators (commas) significantly improves cognitive processing speed and visual clarity.
**Action:** Always format large numeric values with thousands separators in CLI applications to enhance readability.
