...
## 2024-05-25 - Explicit Empty States in CLI
**Learning:** In interactive CLI applications, hiding UI elements (like a high score) when empty can leave users unsure of system state or missing goals. Providing explicit, encouraging empty states (e.g., "None yet!") clarifies functionality and improves onboarding.
