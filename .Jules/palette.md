...
## 2024-05-24 - Polish and Context in CLI Achievements
**Learning:** For games with escalating scores, thousands separators are essential for readability. Furthermore, "New Best" celebrations are more meaningful when accompanied by the previous record, providing immediate context for the player's achievement.
**Action:** Use a helper like `formatWithCommas` for all large numeric displays and include historical context (e.g., "Previous best: X") in achievement messages.
