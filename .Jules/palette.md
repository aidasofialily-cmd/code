...
## 2024-05-14 - Explicit Empty States in CLI
**Learning:** Hiding UI elements like highscores when empty can leave users confused about system state.
**Action:** Always provide explicit, encouraging empty states (e.g., "None yet! Play to set a record!") for data or achievements in CLI applications to improve user onboarding.
