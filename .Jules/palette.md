...
**Learning:** In terminal applications, users benefit from explicit empty states rather than simply hiding information when data is absent (e.g., a score of 0). This provides clearer system state and improves user onboarding.
