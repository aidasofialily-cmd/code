...
## 2024-10-24 - Dynamic CLI Text Clearing
**Learning:** Padding with spaces for dynamic CLI updates can leave trailing artifacts if strings shrink. The ANSI escape sequence \033[K (Erase in Line) is necessary for a clean UI without manual space calculation.
**Action:** Always use \033[K directly after a carriage return (\r) when dynamically updating lines in CLI applications.
