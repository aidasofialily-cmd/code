...
## 2026-06-27 - Digit Grouping for Readability in CLI
**Learning:** In fast-paced CLI games, users need to parse scores instantly. Large unformatted integers are significantly harder to read at a glance than those with thousands separators. Grouping digits reduces cognitive load and allows for quicker assessment of performance.
**Action:** Implement digit grouping for all high-value numeric displays in CLI applications to enhance scanability and immediate feedback.
