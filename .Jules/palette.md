...
## 2024-05-03 - [Erase in Line]
**Learning:** Using `\033[K` (Erase in Line) immediately after a carriage return prevents trailing text artifacts in CLI applications, offering a cleaner and more robust alternative to hardcoding padding spaces.
**Action:** Always use the `\033[K` ANSI escape sequence when dynamically updating terminal lines.
