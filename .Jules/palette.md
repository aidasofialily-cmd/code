...
## 2024-08-27 - CLI Empty States
**Learning:** Hiding UI elements like high scores when empty leaves users unaware that the feature exists. Providing an explicit empty state clarifies system capabilities.
